...
for x in numpy.genfromtxt(
        "/home/telescope/capture-app/capture_app/util/dat/names.dat",
        dtype=None,
        delimiter=[
            36, # obj
            1, # designation
...
# ------------------------------
with fits.open('/home/telescope/capture-app/capture_app/util/dat/VII_118.fits') as hdul:
...
with open('/home/telescope/capture-app/capture_app/util/dat/refined-catalog.dat', 'w') as f:
    for line in objects:
        f.write("%s\n" % line)
