...
from src.api.util import returnResponse, solveField
...
async def solve_field():
    try:
        ...
        solve_response = solveField(
            image_url=res['image'], returnWithData=True, returnWithPoints=True, noplots=False)
