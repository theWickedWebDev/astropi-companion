...
EMPTY_SESSION_DATA = {
    ...
    "frames": {
        "required": {
            "lights": u.DEFAULT_LIGHT_FRAMES_COUNT,
            "darks": u.DEFAULT_DARK_FRAMES_COUNT,
            "flats": u.DEFAULT_FLAT_FRAMES_COUNT
        },
        "captured": {
            "lights": 0,
            "darks": 0,
...
def appendGeneratedData(p, d={}) -> dict:
    modified_time = datetime.fromtimestamp(
        os.path.getmtime(p)).strftime("%A, %B %d, %Y %I:%M:%S")
